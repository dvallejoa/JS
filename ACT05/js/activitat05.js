...
for (vallejo = 0; resultadoa <= 11; vallejo++) {
  document.write(numnueve + "x" +vallejo+ "=" +numnueve*vallejo+"</br>");
  resultadoa++
  document.write("</br>")
}
...
for (vallejo = 10; resultadob <= 11; vallejo--) {
    document.write(numcinco + "x" +vallejo+ "=" +numcinco*vallejo+ "</br>");
    resultadob++
    document.write("</br>")
}
...
for (vallejo = 0; resultadoc <= 101; vallejo++) {
  document.write(numuno + "x" +vallejo+ "=" +numuno*vallejo+ "</br>");
  resultadoc++
  if (vallejo == 10) {
    document.write("</br>");
    vallejo = 0;
